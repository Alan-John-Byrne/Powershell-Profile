...
$userPaths = @(
  ...
  "C:\mingw64\bin",# NOTE:  Essential for Tree-sitter i3n Neovim: provides GCC toolchain for compiling language grammars and native modules.
  "C:\clangd_18.1.3\bin", # NOTE: Essential for clangd LSP support within Neovim.
